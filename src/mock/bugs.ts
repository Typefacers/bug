...
export const bugs: Bug[] = [
  ...
  // Squashed bugs
  {
    ...
    description:
      'Input field exists but is completely transparent. Typing into the void.',
    bounty: 45000,
    active: false,
  ...
  },
  {
    ...
    description:
      'Form keeps changing "email" to "sacrifice" before submission.',
    bounty: 28000,
    active: false,
    createdAt: daysAgo(9),
  ...
  },
  {
    ...
    description:
      'App deletes all browser cookies, including those from other sites.',
    bounty: 8000,
    active: false,
    createdAt: daysAgo(7),
  ...
  },
  {
    ...
    title: 'Audio Ambush',
    description:
      'Site autoplays heavy metal music at 3x volume, cannot be muted.',
    bounty: 1800,
    active: false,
    createdAt: daysAgo(5),
  ...
  },
  {
    ...
    description:
      'Password field reveals password in giant font across entire screen.',
    bounty: 500,
    active: false,
    createdAt: daysAgo(4),
