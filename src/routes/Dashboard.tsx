...
export default function Dashboard() {
  ...
  const raised =
    "border-2 border-t-white border-l-white border-b-gray-500 border-r-gray-500 shadow-sm";
  const sunken =
    "border-2 border-t-gray-500 border-l-gray-500 border-b-white border-r-white shadow-inner";
              ...
              {highestBountyBug ? (
                <div className="space-y-2">
                  ...
                  <div className="pt-2 flex justify-between items-center">
                    <Badge variant="secondary" className={`${highestBountyBug.priority === 'high' ? 'bg-red-100' : highestBountyBug.priority === 'medium' ? 'bg-amber-100' : 'bg-blue-100'}`}>
